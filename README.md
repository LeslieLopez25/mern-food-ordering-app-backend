This is the backend of the Food Ordering App, responsible for managing authentication, users, restaurants, orders, and payments. It exposes a RESTful API consumed by the frontend client.
